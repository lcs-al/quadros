...
ActiveRecord::Schema[7.1].define(version: 20_260_124_173_431) do
  ...
  create_table 'board_memberships', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[board_id user_id], name: 'index_board_memberships_on_board_id_and_user_id', unique: true
  ...
  create_table 'cards', force: :cascade do |t|
    ...
    t.index ['completed_at'], name: 'index_cards_on_completed_at'
